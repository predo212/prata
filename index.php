...
<head>
  ...
  <link rel="stylesheet" href="../tcc/css/style_index.css" />
  <title>Login</title>
</head>
<body>
  <div class="container">
    <div class="panels-container">
      <div class="panel left-panel">
        <img src="../tcc/img/log.svg" class="image" alt="" />
        <div class="content">
          <h3>Novo por aqui?</h3>
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <form class="sign-in-form formLogin" action="../tcc/php/login.php" method="post">
